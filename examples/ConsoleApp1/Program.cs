...
namespace ConsoleAppDecode
{
    class Program
    {
        ...
        private static void DecodeExample()
        {
            ...
            var decodedData = DutchBase45.Decode(qrCodeData.Substring(4));
            var encodedString = DutchBase45.Encode(decodedData);

            var equal = encodedString == qrCodeData.Substring(4);
